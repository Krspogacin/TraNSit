            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                if (stop.getLines() == null) {
                    ...
                    for (Line line : stop.getLines()) {
                        ...
                        lineOneDirection.setTimetablesMap(StopsMapFragment.this.timetableViewModel.findAllByLineIdAndLineDirection(line.getId(), lineOneDirection.getLineDirection()));
                    }
                }
                ...
                for (Line line : stop.getLines()) {
                    ...
                    Date currentTime = StopsMapFragment.dateFormat.parse(StopsMapFragment.dateFormat.format(new Date()));
                    ...
                    if (timetable != null) {
                        ...
                        for (DepartureTime departureTimeObject : timetable.getDepartureTimes()) {
                            Date departureTime = StopsMapFragment.dateFormat.parse(departureTimeObject.getFormattedValue());
